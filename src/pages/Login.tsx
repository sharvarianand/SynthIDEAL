...
import { Mail, Lock, ArrowRight, Eye, EyeOff, Github, Twitter, Facebook } from "lucide-react";
...
export default function Login() {
  ...
  useEffect(() => {
    document.title = "Login - SynthIDEAL";
  }, []);
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome back to SynthIDEAL",
      });
      setIsLoading(false);
    }, 1500);
  };
  ...
  const handleSignup = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to SynthIDEAL",
      });
      setIsLoading(false);
    }, 1500);
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-muted/50 to-background p-4">
      ...
      <Card className="w-full max-w-md">
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login">
            <CardHeader>
              ...
              <CardDescription>Login to your SynthIDEAL account</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <TabsContent value="signup">
            <CardHeader>
              ...
              <CardDescription>Get started with SynthIDEAL</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <CardFooter className="flex justify-center text-sm text-muted-foreground">
          ...
          <Link to="/terms" className="ml-1 underline hover:text-primary">
            Terms of Service
          </Link>{" "}
          and{" "}
          <Link to="/privacy" className="ml-1 underline hover:text-primary">
            Privacy Policy
          </Link>
        </CardFooter>
      </Card>
